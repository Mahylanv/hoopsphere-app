...
export default function EditOffer() {
  ...
  const [positions, setPositions] = useState<string[]>(normalizePositions(offer.position));
    ...
    <SafeAreaView className="flex-1 bg-[#0E0D0D]">
      ...
      <View className="px-5 pt-5 mb-3">
        <View className="flex-row items-center justify-between mb-3">
          ...
          <Text className="text-white text-xl font-bold">Modifier l’offre</Text>
          <View style={{ width: 40 }} />
        </View>
      </View>
      ...
      >
        <View className="bg-[#0E0D0D] border border-white/10 rounded-[20px] p-5 shadow-lg shadow-black/40">
          {/* Champ Titre */}
          <View className="mb-4">
            <Text className="text-gray-300 mb-2 text-[15px]">Titre</Text>
            <TextInput
              placeholder="Ex: Recrutement U18"
              placeholderTextColor="#6b7280"
              value={title}
              onChangeText={setTitle}
              className="bg-[#0e1320] text-white rounded-2xl px-4 py-3 border border-white/10"
            />
          </View>
          ...
          <View className="flex-row gap-3 mb-4">
            <View className="flex-1">
              <Text className="text-gray-300 mb-2 text-[15px]">Postes</Text>
              <TouchableOpacity
                onPress={() => setShowPosteSelect(true)}
                className="bg-[#0e1320] border border-white/10 rounded-2xl px-4 py-3"
              >
            ...
            <View className="flex-1">
              <Text className="text-gray-300 mb-2 text-[15px]">Genres</Text>
              <TouchableOpacity
          ...
          {/* Description */}
          <View className="mb-4">
            <Text className="text-gray-300 mb-2 text-[15px]">Description</Text>
            <TextInput
              placeholder="Décris ton offre ici..."
              placeholderTextColor="#6b7280"
              value={description}
              onChangeText={setDescription}
              className="bg-[#0e1320] text-white rounded-2xl px-4 py-3 border border-white/10 min-h-[110px]"
              multiline
            />
          </View>
          ...
          <View className="flex-row gap-3 mb-4">
            <View className="flex-1">
              <Text className="text-gray-300 mb-2 text-[15px]">Équipe</Text>
              <TextInput
                placeholder="Ex: U18"
                placeholderTextColor="#6b7280"
                value={team}
            ...
            <View className="flex-1">
              <Text className="text-gray-300 mb-2 text-[15px]">
                Tranche d’âge
              </Text>
              <TextInput
          ...
          <View className="flex-row gap-3 mb-6">
            <View className="flex-1">
              <Text className="text-gray-300 mb-2 text-[15px]">Catégorie</Text>
              <TextInput
            ...
            <View className="flex-1">
              <Text className="text-gray-300 mb-2 text-[15px]">Lieu</Text>
              <TextInput
